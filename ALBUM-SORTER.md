...
On September 20, 2026, the user confirmed that version 0.2.0 was published and requested the demo image to show search. Both product pages now use images/album-sorter-search-demo.jpg, a fresh 1280x800 browser capture of the unchanged current controls with six fictional albums and no private data. The local screenshot fixture uses 220px cards to keep the search controls and demo footer visible. The explanatory copy and alternative text include Search and Clear. This visual check is not a live OneDrive integration test.
